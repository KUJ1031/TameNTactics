...
public partial class @PlayerinputAction: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Player_Minigam = m_Player.FindAction("Minigam", throwIfNotFound: true);
    ...
    private readonly InputAction m_Player_Minigam;
    ...
    public struct PlayerActions
    {
        ...
        public InputAction @Minigam => m_Wrapper.m_Player_Minigam;
        ...
        public void AddCallbacks(IPlayerActions instance)
        {
            ...
            @Minigam.started += instance.OnMinigam;
            @Minigam.performed += instance.OnMinigam;
            @Minigam.canceled += instance.OnMinigam;
    ...
    public interface IPlayerActions
    {
        ...
        void OnMinigam(InputAction.CallbackContext context);
