        ...
        guideData = new Dictionary<string, List<GuidePage>>
        {
            ...
            },
            {
                "몬스터", new List<GuidePage>
                {
                    ...
                    new GuidePage("전투 개시", guideImages[4], "플레이어와 접촉 시 전투가 발생합니다."),
                    new GuidePage("인간성..?", guideImages[5], "비록 전염병으로 인해 타락해버린 존재들이지만...\n그들의 인간성은 정말 사라져버린 걸까요?")
                }
            },
            {
                "퀘스트", new List<GuidePage>
                {
                    new GuidePage("퀘스트란", guideImages[6], "플레이어는 진행 도중, NPC로부터 퀘스트를 수주할 수 있습니다."),
                    new GuidePage("수주 중", guideImages[7], "수주 중인 퀘스트는 [퀘스트] 칸을 눌러 확인 가능합니다."),
                    new GuidePage("미수주", guideImages[8], "현재 수주 가능한 퀘스트는 [미수주] 칸을 눌러 확인할 수 있으며,\n 해당 퀘스트를 수주할 수 있는 힌트를 알 수 있습니다."),
                    new GuidePage("완료됨", guideImages[9], "특정 퀘스트를 완료하면, 다음 퀘스트가 열립니다."),
                    new GuidePage("진로", guideImages[10], "앞으로 무엇을 해야할 지 헷갈린다면, 퀘스트창을 열어 확인하면 도움이 될 것입니다.")
                }
            },
            {
                "엔트리", new List<GuidePage>
                {
                    new GuidePage("등록", guideImages[11], "보유 몬스터 중 최대 5명까지\n현재 엔트리에 등록시켜둘 수 있습니다.\n이들은 전투 발생 시 당신의 명령에 따라 전투에 임합니다."),
                    new GuidePage("엔트리", guideImages[12], "엔트리는 [배틀 엔트리]와 [벤치 엔트리]로 나뉩니다.\n배틀 엔트리는 최대 3명까지 등록이 가능하며,\n남은 2명은 벤치 엔트리에 등록됩니다."),
                    new GuidePage("전투 시", guideImages[13], "전투에는 [배틀 엔트리]가 임하게 됩니다.\n[벤치 엔트리]는 전투에 참여할 수 없습니다."),
                    new GuidePage("전투 종료", guideImages[14], "전투 종료 시 [배틀 엔트리]는 경험치를 획득합니다.\n [벤치 엔트리] 또한 경험치를 일부 획득합니다.")
                }
            },
            {
                "전투", new List<GuidePage>
                {
                    new GuidePage("공격", guideImages[15], "[공격하기] 버튼을 눌러 상대를 공격할 태세를 갖춥니다.\n고유 스킬을 이용해 상대를 공격할 수 있습니다."),
                    new GuidePage("턴제", guideImages[16], "공격 시, 공격자와 피격자의 스피드에 따라\n전투 순서가 결정됩니다."),
                    new GuidePage("궁극기", guideImages[17], "파란 게이지가 전부 차면 강력한 [궁극기]를 사용할 수 있습니다.\n캐릭터별로 궁극기의 효과와 채워야하는 게이지양이 전부 상이합니다."),
                    new GuidePage("포섭", guideImages[18], "[포섭하기] 버튼을 눌러 현재 보유하고 있는 제스처를\n통해 상대 몬스터를 포섭 시도할 수 있습니다."),
                    new GuidePage("미니 게임", guideImages[19], "포섭을 시도 시 간단한 미니게임이 진행됩니다.\n플레이어가 사용한 제스처와 상대의 성격에 따라\n미니게임의 난이도가 달라집니다."),
                    new GuidePage("포섭 성공", guideImages[20], "포섭 성공 시, 해당 몬스터는 아군화되며\n상대에게 턴이 넘어갑니다.\n남아 있는 상대가 없을 경우 플레이어측 승리로 전투가 종료됩니다."),
                    new GuidePage("포섭 실패", guideImages[21], "포섭 실패 시, 아무 일도 발생하지 않고\n상대에게 턴이 넘어갑니다."),
                    new GuidePage("인벤토리", guideImages[22], "[인벤토리] 버튼을 눌러 현재 보유하고 있는\n소모 아이템을 사용할 수 있습니다.\n아이템 사용 후에 턴이 상대에게 넘어갑니다."),
                    new GuidePage("도망가기", guideImages[23], "[도망가기] 버튼을 눌러 일정 확률로\n현재 전투에서 벗어날 수 있습니다.\n도주 실패 시 상대에게 턴이 넘어갑니다."),
                }
            },
            {
                "저장", new List<GuidePage>
                {
                    new GuidePage("저장", guideImages[24], "환경 설정 내 [저장하기] 버튼을 눌러\n현재 진행상황을 저장할 수 있습니다."),
                    new GuidePage("이어하기", guideImages[25], "게임 시작 화면에서 [이어하기] 버튼을 눌러\n현재 진행 상황 정보를 확인하고 해당 데이터를 불러올 수 있습니다."),
                    new GuidePage("초기화", guideImages[26], "진행 중 데이터가 있음에도 불구하고 다시 [처음하기]를 통해 게임을 진행할 수 있습니다.\n진행 중이던 데이터는 사라집니다."),
                }
            },
            {
                "미니맵", new List<GuidePage>
                {
                    new GuidePage("미니맵", guideImages[27], "미니맵 단축 키(M)를 통해 현재 플레이어의\n위치를 파악할 수 있습니다.")
                }
            },
            {
                "대화", new List<GuidePage>
                {
                    new GuidePage("NPC", guideImages[28], "필드에는 플레이어와 상호작용할 수 있는 NPC들이\n존재합니다. 몬스터와는 달리 테두리가 파랗습니다."),
                    new GuidePage("대화 시도", guideImages[29], "상호작용 키(F)를 통해 NPC와 상호작용할 수 있습니다."),
                    new GuidePage("보상?", guideImages[30], "NPC의 대화를 잘 들어준다면, 좋은 일이 생길 지도 모릅니다..."),
                }
            },
            {
                "상점", new List<GuidePage>
                {
                    new GuidePage("구매", guideImages[31], "상점에서는 소모품이나 무기, 제스처 등을 구매할 수 있습니다."),
                    new GuidePage("판매", guideImages[32], "구매하거나 획득한 아이템을 구매가의 70%의 가격으로 판매할 수도 있습니다."),
                }
            },
            {
                "힐링존", new List<GuidePage>
                {
                    new GuidePage("휴식", guideImages[33], "힐링존에서는 현재 보유 중인 모든 몬스터를\n회복시키거나, 엔트리에 등록된 몬스터들을\n회복시킬 수 있습니다."),
                    new GuidePage("가격", guideImages[34], "힐링존을 이용하기 위해서는 골드가 필요하며,\n모든 몬스터를 회복시키려면 조금 더 많은 골드가\n필요합니다."),
                    new GuidePage("효과", guideImages[35], "해당 효과를 받은 모든 몬스터들은 Hp가 전부 회복됩니다. 단, 궁극기 게이지도 전부 초기화됩니다.")
                }
            },
            {
                "아이템", new List<GuidePage>
                {
                    new GuidePage("소모품", guideImages[36], "물약 등 소모품을 사용할 수 있습니다.\n전투 중이나 필드 어디서든 전부 사용이 가능합니다."),
                    new GuidePage("장착템", guideImages[37], "아이템 장착 시, 해당 효과가 모든 몬스터에게 적용됩니다.\n필드에서만 사용 가능합니다."),
                    new GuidePage("제스처", guideImages[38], "배틀 중 포섭 진행 시 사용되는 아이템입니다.\n전투에서만 사용 가능합니다.")
                }
            },
